    ...
    >
      <div className="relative flex flex-col md:flex-row w-full max-w-7xl px-4 xs:px-6 md:px-20 py-14 xs:py-20 md:py-40 gap-10 xs:gap-16 md:gap-24 items-center z-10">
        ...
        <div className="flex-1 flex flex-col gap-6 text-left w-full">
          ...
          <h2
            className="text-2xl xs:text-3xl md:text-5xl font-black bg-gradient-to-r from-[color:var(--color-primary)] via-[color:var(--color-accent)] to-[color:var(--color-secondary)] bg-clip-text text-transparent drop-shadow-[0_2px_16px_rgba(0,0,0,0.08)] animate-gradient"
            style={{
          ...
          <p
            className="text-base xs:text-lg md:text-xl font-light text-[color:var(--color-dark)]/90 max-w-xl leading-relaxed"
